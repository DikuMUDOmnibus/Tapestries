...
bool dragon( CHAR_DATA *ch, char *spell_name )
{
	...
	return FALSE;
    (*skill_table[sn].spell_fun) ( sn, 50, ch, victim ); /* TODO */
    return TRUE;
}
...
bool spec_breath_gas( CHAR_DATA *ch )
{
	...
	return FALSE;
    (*skill_table[sn].spell_fun) ( sn, 50, ch, NULL );
    return TRUE;
}
...
bool spec_cast_adept( CHAR_DATA *ch )
{
	...
	spell_armor( skill_lookup( "armor" ), 50, ch, victim );
	return TRUE;

    case 1:
	act( "$n utters the word 'nhak'.", ch, NULL, NULL, TO_ROOM );
	spell_bless( skill_lookup( "bless" ), 50, ch, victim );
	return TRUE;
	...
	spell_refresh( skill_lookup( "refresh" ), 50, ch, victim );
	return TRUE;
...
bool spec_fido( CHAR_DATA *ch )
{
	...
	if( !IS_SET( corpse->item_type, ITEM_CORPSE_NPC ) )
	    continue;
...
bool spec_thief( CHAR_DATA *ch )
{
	...
	if( IS_AWAKE( victim ) && number_range( 0, 25 ) == 0 ) /* TODO */
	{
